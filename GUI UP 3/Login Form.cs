...
namespace GUI
{
    public partial class Login_Form_Window : Form
    {
        ...
        private void ApplyTemporaryBlock()
        {
        ...
        private void ApplyPermanentBlock()
        {
        ...
        private string GetRoleByStatusID(int userStatusID)
        {
            if (userStatusID == 1)
            {
                return "Менеджер";
        ...
        private void Login_Form_Window_Load(object sender, EventArgs e)
        {
