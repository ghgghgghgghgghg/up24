...
namespace GUI
{
    public partial class OperatorForm : Form
    {
        ...
        private void btn_edit_request_Click(object sender, EventArgs e)
        {
            ...
            if (requestStatus != "Новая заявка" && requestStatus != "В процессе ремонта")
            {
            ...
            E_r_f_op editForm = new E_r_f_op(selectedRequestID, startDate, problemDescription, requestStatus, completionDate, repairParts, master);
            editForm.ShowDialog();
            LoadAllRequestsForOperator();
        }
